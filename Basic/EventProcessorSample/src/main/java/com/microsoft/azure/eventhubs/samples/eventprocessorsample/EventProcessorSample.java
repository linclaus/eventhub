...
public class EventProcessorSample {
    public static void main(String args[]) throws InterruptedException, ExecutionException, IOException, URISyntaxException {
        ...
        InputStream in = EventProcessor.class.getClassLoader().getResourceAsStream("conf.properties");
        properties.load(in);
        String consumerGroupName = properties.getProperty("eventhub.consumergroupname");
        String namespaceName = properties.getProperty("eventhub.namespace");
        String endPoint = properties.getProperty("eventhub.endpoint");
        String eventHubName = properties.getProperty("eventhub.name");
        String sasKeyName = properties.getProperty("eventhub.saskeyname");
        String sasKey = properties.getProperty("eventhub.saskey");
        String storageConnectionString = properties.getProperty("blob.storageconnectionstring");
        String storageContainerName = properties.getProperty("blob.storagecontainername");
        String hostName = "host02";
