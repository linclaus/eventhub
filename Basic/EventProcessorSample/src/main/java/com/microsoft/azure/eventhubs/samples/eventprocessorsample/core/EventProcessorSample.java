 ...
 */
package com.microsoft.azure.eventhubs.samples.eventprocessorsample.core;

import com.microsoft.azure.eventhubs.ConnectionStringBuilder;
import com.microsoft.azure.eventhubs.EventData;
import com.microsoft.azure.eventhubs.samples.eventprocessorsample.bean.BlobProperties;
import com.microsoft.azure.eventhubs.samples.eventprocessorsample.bean.EventhubProperties;
...
public class EventProcessorSample {
    public static void main(String args[]) throws InterruptedException, ExecutionException, IOException, URISyntaxException {
        ...
        BlobProperties blobProperties = (BlobProperties) beanFactory.getBean("blobProperties");
        String consumerGroupName = eventhubProperties.getConsumerGroupName();
        String namespaceName = eventhubProperties.getNamespace();
        String endPoint = eventhubProperties.getEndpoint();
        String eventHubName = eventhubProperties.getName();
        String sasKeyName = eventhubProperties.getSasKeyName();
        String sasKey = eventhubProperties.getSasKey();
        String storageConnectionString = blobProperties.getStorageConnectionString();
        String storageContainerName = blobProperties.getStorageContainerName();
        String hostName = "host03";
